...
const RIGHT_SIDEBAR_WIDTH = "15rem";
const LEFT_SIDEBAR_WIDTH = "14rem";
...
const SidebarContext = React.createContext<MultiSidebarContextType | null>(
  null,
);
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-50 hidden h-svh w-[--left-sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
              ? "left-0 w-[--left-sidebar-width] group-data-[collapsible=offcanvas]:left-[calc(var(--left-sidebar-width)*-1)]"
